...
(define (relate x R)
  "TODO: Implement"
  (if (equal? R '()) '()
  (if (equal? (car (car R)) x) (append (list(car (cdr (car R)))) (relate x (cdr R))) (append '() (relate x (cdr R)))))
  )
...
(define (injective? R)
  "TODO: Implement"
(equal? (make-set (injectiveH R)) (injectiveH R))
  )

(define (injectiveH R)
  (if (equal? R '()) '()
(append (list (car (cdr (car R)))) (injectiveH (cdr R)))))
