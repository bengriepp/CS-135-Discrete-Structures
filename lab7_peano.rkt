...
(define (p- a b)
  "TODO: Implement"
  (if (and (pz? a) (not (pz? b))) (error-subtraction)
...
(define (p% a b)
  "TODO: Implement"
  (if (pz? b) (error-modulo)
  (if (p> b a) a (p% (p- a b) b))
  ))
